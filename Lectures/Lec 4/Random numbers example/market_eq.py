...
class MarketEq():
    ...
    def excess_demand_good_1_func(self,p1,p2):
        ...
        #CHR: You calculate the distribution of demand for all the alphas
        # and then you sum so you have the total demand.
        
        # b. supply
        supply = self.k*self.N 
        #CHR: the supply is just k*N
    ...
    def find_equilibrium(self,p1_guess,p2):
        ...
        t = 0 #CHR: Counter to count how many iterations we have done
        p1 = p1_guess #CHR: Initial guess
        ...
        while True:
            ...
            if  np.abs(Z1) < self.eps or t >= self.maxiter:
                ...
                break    
            #CHR: np.abs is the absolute value
            # or >= self.maxiter - we set this because we don't want python to iterate forever.    
